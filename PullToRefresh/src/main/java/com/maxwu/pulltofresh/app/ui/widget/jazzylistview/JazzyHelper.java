 ...
 */
package com.maxwu.pulltofresh.app.ui.widget.jazzylistview;
...
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.CardsEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.CurlEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.FadeEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.FanEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.FlipEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.FlyEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.GrowEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.HelixEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.ReverseFlyEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.SlideInEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.StandardEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.TiltEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.TwirlEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.WaveEffect;
import com.maxwu.pulltofresh.app.ui.widget.jazzylistview.effects.ZipperEffect;
...
public class JazzyHelper implements AbsListView.OnScrollListener {
    ...
    private void setVelocity(int firstVisibleItem, int totalItemCount) {
		Log.e("MaxWu","setVelocity firstVisibleItem="+firstVisibleItem+" totalItemCount="+totalItemCount);
    ...
    private void doJazziness(View item, int position, int scrollDirection) {
		Log.e("MaxWu","doJazziness position="+position+" scrollDirection="+scrollDirection);
        Log.e("MaxWu","mOnlyAnimateNewItems="+mOnlyAnimateNewItems);
		Log.e("MaxWu","mOnlyAnimateOnFling="+mOnlyAnimateOnFling);
		if (mIsScrolling) {
			...
			Log.e("MaxWu","step3");
			Log.e("MaxWu","mSimulateGridWithList="+mSimulateGridWithList);
    ...
    private void doJazzinessImpl(View item, int position, int scrollDirection) {
		...
		Log.e("MaxWu","doJazzinessImpl position="+position+" scrollDirection="+scrollDirection);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		Log.e("MaxWu","onScrollStateChanged scrollState="+scrollState);
