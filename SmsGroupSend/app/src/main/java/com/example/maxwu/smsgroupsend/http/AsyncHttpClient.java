...
package com.example.maxwu.smsgroupsend.http;
...
public class AsyncHttpClient {
	...
	public String syncGet(String url, RequestParams params, Header[] headers) throws ClientProtocolException, IOException {
		...
		for(Header header : headers){
			Log.i("Max", "headerName  = "+header.getName()+" headerValue="+header.getValue());
		}
		get.setHeaders(headers);
		return parseResponse(syncExec(get));
	}
	...
	public String syncPost(String url, RequestParams params,Header[] headers) throws ClientProtocolException, IOException{
		return syncPost(url,headers, paramsToEntity(params));
	}
